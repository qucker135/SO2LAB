...
#find -type f \( -not -perm /ugo+w \) -and \( -path './aaa/*' -or -path './bbb/*' \)

[ -d ddd/zapasy ] || mkdir ddd/zapasy
cp --parents $(find -type f \( -not -perm /ugo+w \) -and \( -path './aaa/*' -or -path './bbb/*' \)) ddd/zapasy
